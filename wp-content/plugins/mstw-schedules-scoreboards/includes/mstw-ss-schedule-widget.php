...
class mstw_ss_sched_widget extends WP_Widget {
    ...
    public function mstw_ss_sched_widget( ) {
		...
		WP_Widget::__construct( 'mstw_ss_sched_widget', 'MSTW Game Schedules', $widget_ops );
    }
	...
	function widget( $args, $instance ) {
		...
		if($posts) {	
        	...
        	<table class="mstw-ss-table mstw-ss-table_<?php echo $sched_id; ?>">
        	<!-- <thead class="mstw-ss-table-head mstw-ss-table-head_<?php echo $sched_id; ?>"><tr> -->
			<thead>
				<tr>
